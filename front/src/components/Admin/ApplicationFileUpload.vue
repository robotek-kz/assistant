...
export default {
    ...
    computed: {
        ...mapGetters("application_files", ["getApplicationFiles"])
    },
    mounted() {
        console.log('hello', this.application);
        this.all(this.application.id);
    },
    methods: {
        ...mapActions("application_files", ["all"]),
        ...mapActions("sets", ["addFile"]),
        onChange(e) {
        ...
        onSubmit() {
            ...
            const data = {'formData':this.formData, 'application': this.application};
